...
public class DoubleLinkedList14 {
    ...
    public void addLast (int item) {
        if (isEmpty()) {
            ...
            Node14 newNode14 = new Node14(current, item, null);
    ...
    public void add(int item, int index) throws Exception {
        if (isEmpty()) {
            ...
            throw new Exception("Nilai indeks di luuar batas");
        }else {
            Node14 current = head;
            int i = 0;
            while (i < index) {
                ...
                Node14 newNode14 = new Node14(null, item, current);
                current.prev = newNode14;
                head = newNode14;
            } else {
                Node14 newNode14 = new Node14(current.prev, item, current);
