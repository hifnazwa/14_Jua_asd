...
public class DoubleLinkedListFilm14 {
    ...
    public void addFirst(int id, String judulFilm, double rating){
        if (isEmpty()){
            head  = new NodeFilm14(null, id, judulFilm, rating, null);
        
        }else{
            NodeFilm14 newNodeFilm = new NodeFilm14(null, id, judulFilm, rating, head);
    ...
    public void addLast(int id, String judulFilm, double rating){
        if (isEmpty()){
            ...
            NodeFilm14 newNodeFilm = new NodeFilm14(current, id, judulFilm, rating, null);
    ...
    public void add(int id, String judulFilm, double rating, int index) throws Exception {
        if (isEmpty()){
            ...
            if(current.prev == null){
                NodeFilm14 newNodeFilm = new NodeFilm14(null, id, judulFilm, rating, current);
                current.prev = newNodeFilm;
                head = newNodeFilm;
            }else{
                NodeFilm14 newNodeFilm = new NodeFilm14(current.prev, id, judulFilm, rating, current);
    ...
    public void sort(){
        NodeFilm14 current = null, index = null;
        int tempID;
        String tempJD;
        Double tempRT;
        if (head == null) {
