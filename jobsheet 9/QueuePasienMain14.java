...
public class QueuePasienMain14 {
    public static void main(String[] args) {
        Scanner sc = new Scanner(System.in);
        System.out.print("Masukkan kapasitas antrian: ");
        int capacity = sc.nextInt();
        QueuePasien14 antrian = new QueuePasien14(capacity);
        ...
        do {
            ...
            switch (pilihan) {
                case 1:
                    ...
                    Pasien14 pb = new Pasien14(nama, noID, jenisKelamin, umur);
                    sc.nextLine();
                    antrian.enqueue(pb);
                    break;
                case 2:
                    Pasien14 pasienHapus = antrian.dequeue();
                    if (pasienHapus != null) {
